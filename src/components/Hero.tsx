                ...
                <div className="grid lg:grid-cols-2 gap-32 items-center">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <a href="https://drive.google.com/file/d/1fiWC7-_H0AfwCdlVGT_vyfNvQd8VJ4_e/view?usp=drive_link" target="_blank" className="px-8 py-4 border border-white/10 text-xs tracking-[0.2em] uppercase hover:bg-white/5 hover:border-[#ff4d00] transition-all lg:cursor-none">
                                Resume
                            </a>
                        </motion.div>
                    </div>
